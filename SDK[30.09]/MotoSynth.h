...
public:
	...
	void SetSettings(FMotoSynthRuntimeSettings& InSettings);                                                                 // [0xeb5df0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.SetRPM
	void SetRPM(float InRPM, float InTimeSec);                                                                               // [0xeb5d20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.IsEnabled
	bool IsEnabled();                                                                                                        // [0xeb5cf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotoSynth.SynthComponentMoto.GetRPMRange
	void GetRPMRange(float& OutMinRPM, float& OutMaxRPM);                                                                    // [0xeb5c10] Final|Native|Public|HasOutParms|BlueprintCallable 
};
