...
/// Size: 0x0030 (0x000EF0 - 0x000F20)
class USkeletalMeshComponentBudgeted : public USkeletalMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x0EF0   (0x0020)  MISSED
	bool                                               bAutoRegisterWithBudgetAllocator;                           // 0x0F10:0 (0x0001)  
	bool                                               bAutoCalculateSignificance;                                 // 0x0F10:1 (0x0001)  
	bool                                               bShouldUseActorRenderedFlag;                                // 0x0F10:2 (0x0001)  
	unsigned char                                      UnknownData01_6[0xF];                                       // 0x0F11   (0x000F)  MISSED


	/// Functions
	// Function /Script/AnimationBudgetAllocator.SkeletalMeshComponentBudgeted.SetAutoRegisterWithBudgetAllocator
	void SetAutoRegisterWithBudgetAllocator(bool bInAutoRegisterWithBudgetAllocator);                                        // [0xd0ddb0] Final|Native|Public|BlueprintCallable 
};
